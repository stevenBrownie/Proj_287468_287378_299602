...
3. Run this script with the command:
   python3 test.py -d path_to_data_folder -p path_to_root_project_folder
    python3 test.py -d /Users/stevenbrown/Deep_learning/Project -p /Users/stevenbrown/Deep_learning/Project/Proj_287468_287378_299602
4. More tests will be present in the final test.py that we will be running
"""


#project_path=Path('/Users/stevenbrown/Deep_learning/Project/proj_287468_287378_299602')
